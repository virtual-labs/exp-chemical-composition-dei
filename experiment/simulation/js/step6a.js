// JavaScript for Step 6a of the Chemical Composition of Cement experiment
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupClickableArea() {
        ...
        // Position clickable area over the funnel (adjust these values based on 6a.png)
        // These are approximate values - you'll need to adjust them based on where the funnel is in your image
        equipmentClickable.style.left = imgWidth * 0.14 + 'px'; // 35% from the left
        equipmentClickable.style.top = imgHeight * 0.05 + 'px'; // 25% from the top
        equipmentClickable.style.width = imgWidth * 0.12 + 'px'; // 20% of image width
    ...
    equipmentClickable.addEventListener('click', function() {
        ...
        const gifDuration = 5000; // 5 seconds - for filtration process
