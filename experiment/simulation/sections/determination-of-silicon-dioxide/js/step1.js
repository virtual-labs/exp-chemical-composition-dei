// JavaScript for Step 1 of Determination of Silicon Dioxide (SiO₂)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Position the clickable area over the HNO3 bottle on the image
    ...
    function setupClickableArea() {
        ...
        // Position clickable area over the HNO3 bottle (adjust these values as needed)
        // These are approximate values - you'll need to adjust them based on where the bottle is in your image
        equipmentClickable.style.left = imgWidth * 0.87 + 'px'; // 87% from the left
        equipmentClickable.style.top = imgHeight * 0.05 + 'px'; // 5% from the top
    ...
    equipmentClickable.addEventListener('click', function() {
        ...
        const gifDuration = 9500; // 8 seconds - replace with actual duration of your GIF
