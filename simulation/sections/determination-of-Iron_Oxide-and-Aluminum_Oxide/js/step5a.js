// JavaScript for Step 5a: Filtration, Washing, and Drying of Aluminium Hydroxide Precipitate
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Position the clickable area over the washing equipment on the image
    ...
    function setupClickableArea() {
        ...
        equipmentClickable.style.left = imgWidth * 0.30 + 'px'; // 40% from the left
    ...
    equipmentClickable.addEventListener('click', function() {
        ...
        // Calculate the duration of the GIF (washing process)
        const gifDuration = 3000; // 3 seconds for washing process
    ...
    nextStepButton.addEventListener('click', function() {
        window.location.href = 'Step5b.html';
    });
