...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupClickableArea() {
        ...
        equipmentClickable.style.left = imgWidth * 0.45 + 'px'; // 20% from the left
        equipmentClickable.style.top = imgHeight * 0.50 + 'px'; // 15% from the top
    ...
    equipmentClickable.addEventListener('click', function() {
        ...
        const gifDuration = 1000; // 1 second - replace with actual duration of your GIF
